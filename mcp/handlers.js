/**
 * Animatic MCP tool handlers (PRE-1439).
 *
 * Every `handle*` function — one per registered tool — plus three private
 * helpers (formatPrimitivesTable, loadHeroMoments, motionResult). Extracted
 * verbatim from index.js so the dispatch logic can be registered onto BOTH the
 * stdio server and (later, in the Preset repo) a stateless edge function,
 * without dragging in the stdio bootstrap.
 *
 * Catalog/registry state is imported from runtime.js as ESM live bindings, so
 * the stdio hot-reload path (reloadCatalogsIfStale, invoked by index.js) is
...
// ── Handler support data (moved from index.js, PRE-1439) ──────────────────
...
export function handleSearchPrimitives(args) {
...
export function formatPrimitivesTable(entries) {
...
export function handleGetPrimitive(args) {
  const { id } = args;
...
export function handleGetBreakdown(args) {
  const { slug } = args;
...
export function handleGetReferenceDoc(args) {
  const { name } = args;
...
export function handleRecommendChoreography(args) {
...
export function handleValidateChoreography(args) {
...
export function handleGetStylePack(args) {
  const { name } = args;
...
export function handleEvaluateSequence(args) {
...
export function handleValidateManifest(args) {
...
export function handleListBriefTemplates() {
...
export function handleGetBriefTemplate(args) {
...
export async function handleGenerateScenes(args) {
...
export function handlePlanVariants(args) {
...
export function handleCompareVariants(args) {
...
export function handleAnalyzeBeats(args) {
...
export function handleSyncSequenceToBeats(args) {
...
export function handleCreatePersonality(args) {
...
export function handleListPersonalities() {
...
export function handleCompileMotion(args) {
...
export function handleCritiqueMotion(args) {
...
export function handleRunBenchmarks() {
  try {
...
export function handleInstantiateSequenceArchetype(args) {
...
export function handleRecommendSequenceArchetype(args) {
...
export async function handleSaveProjectArtifact(args) {
...
export function handleListArtDirections(args) {
...
export function loadHeroMoments() {
...
export function handlePlanHeroMoments(args) {
...
export function handleScoreBrandFinish(args) {
...
export function handleCreateBrandPackage(args) {
...
export function handleGetBrandPackage(args) {
...
export function handleListBrandPackages() {
...
export function handleValidateBrandCompliance(args) {
  const brand = loadBrand(args.brand_id);
  if (!brand) {
...
export function handleScoreProductDemoClarity(args) {
...
export async function handleAnalyzeSceneComprehension(args) {
...
export function handleGenerateContactSheet(args) {
...
export function handleCompareProjectVersions(args) {
...
export function handleCreateEditorialCanvasScene(args) {
...
export function handleRecommendEditorialLayout(args) {
...
export function handleRecommendUiStoryboardLayout(args) {
  return { content: [{ type: 'text', text: JSON.stringify(recommendUiStoryboardLayout(args || {}), null, 2) }] };
}

export function handleRecommendPersonalityForContext(args) {
...
export function motionResult(result) {
  if (result.error) {
    return { content: [{ type: 'text', text: result.error }], isError: true };
  }
  return { content: [{ type: 'text', text: JSON.stringify(result, null, 2) }] };
...
export function handleGetMotionRecipe(args) {
  return motionResult(getMotionRecipe(args || {}));
}

export function handleSearchMotionRecipes(args) {
  return motionResult(searchMotionRecipes(args || {}));
}

export function handleValidateMotionToken(args) {
  return motionResult(validateMotionToken(args || {}));
}

export function handleAuditMotionCoverage(args) {
  return motionResult(auditMotionCoverage(args || {}));
}

export function handleAdaptProjectAspectRatio(args) {
...
export function handleCreateSocialCutdown(args) {
...
export function handleRecommendTypeTreatment(args) {
...
export function handleSuggestMatchCuts(args) {
...
export function handlePlanContinuityLinks(args) {
...
export function handleExtractStoryBrief(args) {
...
export async function handleComposeStoryboard(args) {
...
export function handlePlanStoryBeats(args) {
...
export function handleScoreCandidateVideo(args) {
...
export function handleReviseCandidateVideo(args) {
...
export function handleCompareCandidateVideos(args) {
...
export function handlePreviewVideo(args) {
  const { input } = args;
  if (!input) {
...
export function handleGetDeliveryProfile(args) {
  if (args.slug) {
...
export function handleAssembleVideoSequence(args) {
...
export function handleResolveRenderTargets(args) {
...
export function handleScoreFrameStrip(args) {
...
export function handleGenerateBriefStub(args) {
...
export function handleUpgradeProjectConfidence(args) {
...
export function handleAuditAnnotationQuality(args) {
...
export function handleAnnotateScenes(args) {
  const { scenes } = args;
  if (!scenes || !Array.isArray(scenes) || scenes.length === 0) {
    return { content: [{ type: 'text', text: 'scenes must be a non-empty array' }], isError: true };
  }
